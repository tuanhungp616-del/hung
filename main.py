...
async def scan_game(tool: str, key: str):
    ...
    if row[1] == 1 and key != "hungadmin": return {"status": "error", "msg": "Key này đã bị khóa!"}
    ...
    except Exception as e: return {"status": "error", "msg": "Nhiễu sóng từ nhà cái!"}
